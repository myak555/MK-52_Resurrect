...
namespace MK52Simulator
{
    public partial class KBD_Manager : UserControl
    {
        ...
        public KBD_Manager()
        {
            ...
            m_Buttons.Add(new RPN_Button(40, 223, "Mode")); // Modal "ââ" button (degs-rads-grads and code/text/addr)
            ...
            m_Buttons.Add(new RPN_Button(360, 223, "/-/", "Y", "B")); // "/-/", "ÀÂÒ", "OR"
            ...
            m_Buttons.Add(new RPN_Button(420, 223, "EE", "Z", "C")); // "ÂÏ", "ÏÐÃ", "XOR", "LIST"
