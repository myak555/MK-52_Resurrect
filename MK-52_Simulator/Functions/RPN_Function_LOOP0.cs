...
{
    public class RPN_Function_LOOP0 : RPN_Function
    {
        public RPN_Function_LOOP0(RPN_Calculator parent)
            : base(parent)
        {
            Keyword = "WHILE L0>0 GOTO ";
        ...
        public override bool executeCODE(string code)
        {
            ...
            int lp = _parent.Registers.DecrementLoopRegister(0);
            if ( lp > 0)
